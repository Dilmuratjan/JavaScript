...
!function (a, b) {
  ...
  r.extend = r.fn.extend = function () {
    ...
    d = a[b],
    g !== d && (j && d && (r.isPlainObject(d) || (e = r.isArray(d))) ? (e ? (e = !1, f = c && r.isArray(c) ? c : [
  ...
  var x = function (a) {
    ...
    function ga(a, b, d, e) {
      ...
      w = b ? b.nodeType : 9;
      if (d = d || [
      ], 'string' != typeof a || !a || 1 !== w && 9 !== w && 11 !== w) return d;
    ...
    i = ga.select = function (a, b, e, f) {
      ...
      if (e = e || [
        ...
        if (j = o[0] = o[0].slice(0), j.length > 2 && 'ID' === (k = j[0]).type && c.getById && 9 === b.nodeType && p && d.relative[j[1].type]) {
          if (b = (d.find.ID(k.matches[0].replace(_, aa), b) || [
          ]) [0], !b) return e;
          n && (b = b.parentNode),
  ...
  r.fn.extend({
    ...
    is: function (a) {
      return !!D(this, 'string' == typeof a && A.test(a) ? r(a)  : a || [
      ], !1).length
    }
  });
  var E,
  ...
  function oa(a, b, c, d, e) {
    ...
    ], n = 0, o = a.length; n < o; n++) if (f = a[n], f || 0 === f) if ('object' === r.type(f)) r.merge(m, f.nodeType ? [
      f
    ] : f);
     else if (na.test(f)) {
  ...
  r.event = {
    ...
    add: function (a, b, c, d, e) {
      ...
      if (q) {
        ...
        ], m.delegateCount = 0, l.setup && l.setup.call(a, d, o, g) !== !1 || a.addEventListener && a.addEventListener(n, g)), l.add && (l.add.call(a, k), k.handler.guid || (k.handler.guid = c.guid)), e ? m.splice(m.delegateCount++, 0, k)  : m.push(k), r.event.global[n] = !0)
      }
    },
  ...
  r.each({
    ...
    r.fn[a] = function (a) {
      for (var c, d = [
      ], e = r(a), f = e.length - 1, g = 0; g <= f; g++) c = g === f ? this : this.clone(!0),
      r(e[g]) [b](c),
      h.apply(d, c.get());
  ...
  r.each(r.expr.match.bool.source.match(/\w+/g), function (a, b) {
    ...
    Ya[b] = function (a, b, d) {
      ...
      f,
      g = b.toLowerCase();
      return d || (f = Ya[g], Ya[g] = e, e = null != c(a, b, d) ? g : null, Ya[g] = f),
      e
    }
  });
  ...
  r.extend({
    valHooks: {
      ...
      select: {
        get: function (a) {
          for (var b, c, d = a.options, e = a.selectedIndex, f = 'select-one' === a.type, g = f ? null : [
          ], h = f ? e + 1 : d.length, i = e < 0 ? h : f ? e : 0; i < h; i++) if (c = d[i], (c.selected || i === e) && !c.disabled && (!c.parentNode.disabled || !r.nodeName(c.parentNode, 'optgroup'))) {
  ...
  r.extend(r.event, {
    trigger: function (b, c, e, f) {
      ...
      if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !db.test(p + r.event.triggered) && (p.indexOf('.') > - 1 && (q = p.split('.'), p = q.shift(), q.sort()), k = p.indexOf(':') < 0 && 'on' + p, b = b[r.expando] ? b : new r.Event(p, 'object' == typeof b && b), b.isTrigger = f ? 2 : 3, b.namespace = q.join('.'), b.rnamespace = b.namespace ? new RegExp('(^|\\.)' + q.join('\\.(?:.*\\.|)') + '(\\.|$)')  : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [
        b
      ] : r.makeArray(c, [
        b
      ]), n = r.event.special[p] || {
        ...
        if (!f && !n.noBubble && !r.isWindow(e)) {
          for (j = n.delegateType || p, db.test(j + p) || (h = h.parentNode); h; h = h.parentNode) o.push(h),
          i = h;
